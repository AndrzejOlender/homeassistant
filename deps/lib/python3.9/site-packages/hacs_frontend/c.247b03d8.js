        ...
        <div class="content">
          ...
          <div class="action">
            ${this.actionText?o`<mwc-button
                ...
                ></mwc-button>`:this.dismissable?o`<mwc-icon-button
